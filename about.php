...
<head>
	...
	<script>
		function change1() {
  			...
  			document.getElementById("h2text").innerText = "明道";
		}

		function change2() {
  			document.getElementById("pic").src = "cliff.jpg";
  			document.getElementById("h2text").innerText = "Lucy Yang";
		}
	</script>
	...
	<table width="70%" border="3">
		<tr>
			<td>
				...
				E-Mail: <a href="mailto:lucyyang1221@gmai.com">lucyyang1221@gmai.com</a><br>
			</td>
